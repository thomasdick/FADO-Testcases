...
config = SU2.io.Config("opt_RAE2822_CL_orig.cfg")
...
meshDeformationRun = SU2MeshDeformationSkipFirstIteration("DEFORM","mpirun -n 4 SU2_DEF opt_RAE2822_CL_tmpl.cfg",True,"opt_RAE2822_CL_tmpl.cfg")
meshDeformationRun.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
### FOR FLOW SOLUTION ###
directRun = ExternalSU2CFDSingleZoneDriverWithRestartOption("DIRECT","mpirun -n 4 SU2_CFD opt_RAE2822_CL_tmpl.cfg",True,"opt_RAE2822_CL_tmpl.cfg")
directRun.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
adjointRunDrag = ExternalSU2CFDDiscAdjSingleZoneDriverWithRestartOption("ADJOINT_DRAG","mpirun -n 4 SU2_CFD_AD opt_RAE2822_CL_tmpl.cfg",True,"opt_RAE2822_CL_tmpl.cfg")
adjointRunDrag.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
dotProductRunDrag = ExternalRun("DOT_DRAG","mpirun -n 4 SU2_DOT_AD opt_RAE2822_CL_tmpl.cfg",True)
dotProductRunDrag.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
hessianRunDrag = ExternalSU2CFDDiscAdjSingleZoneDriverWithRestartOption("HESSIAN","mpirun -n 4 SU2_CFD_AD opt_RAE2822_CL_tmpl.cfg",True,"opt_RAE2822_CL_tmpl.cfg")
hessianRunDrag.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
adjointRunMomZ = ExternalSU2CFDDiscAdjSingleZoneDriverWithRestartOption("ADJOINT_MOMENT_Z","mpirun -n 4 SU2_CFD_AD opt_RAE2822_CL_tmpl.cfg",True,"opt_RAE2822_CL_tmpl.cfg")
adjointRunMomZ.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
dotProductRunMomZ = ExternalRun("DOT_MOMENT_Z","mpirun -n 4 SU2_DOT_AD opt_RAE2822_CL_tmpl.cfg",True)
dotProductRunMomZ.addConfig("opt_RAE2822_CL_tmpl.cfg")
...
geometryFDRun = ExternalRun("GEOMETRY", "mpirun -n 4 SU2_GEO opt_RAE2822_CL_tmpl.cfg",True)
geometryFDRun.addConfig("opt_RAE2822_CL_tmpl.cfg")
