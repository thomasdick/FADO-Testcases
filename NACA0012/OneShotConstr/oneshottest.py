...
config = SU2.io.Config("NACA0012_oneshot_config.cfg")
...
pType_Iter_piggysteps = Parameter(["50"],LabelReplacer("__NUM_ITER__"))
...
### ALL IN ONE RUN ###
optimizerRun = ExternalSU2CFDOneShotSingleZoneDriverWithRestartOption("ONESHOT","mpirun -n 4 SU2_CFD_AD NACA0012_oneshot_tmpl.cfg",True,"NACA0012_oneshot_tmpl.cfg")
optimizerRun.addConfig("NACA0012_oneshot_tmpl.cfg")
...
fun = Function("RUN","ONESHOT/history.csv",TableReader(0,0,start=(-1,12),end=(None,None),delim=","))
