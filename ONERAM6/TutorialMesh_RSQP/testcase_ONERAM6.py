...
fun = Function("DRAG","DIRECT/history.dat",TableReader(0,0,start=(-1,9),end=(None,None),delim=","))
...
liftConstraint = Function("LIFT","DIRECT/history.dat",TableReader(0,0,start=(-1,10),end=(None,None),delim=","))
