...
config = SU2.io.Config("config_orig.cfg")
...
pType_mesh_filename_deformed = Parameter(["str3_ffdhand_def.su2"],LabelReplacer("__MESH_FILENAME__"))
...
hessianRunDrag = ExternalSU2CFDDiscAdjSingleZoneDriverWithRestartOption("HESSIAN","mpirun -n 4 SU2_CFD_AD config_tmpl.cfg",True,"config_tmpl.cfg")
hessianRunDrag.addConfig("config_tmpl.cfg")
...
geometryFDRun = ExternalRun("GEOMETRY", "mpirun -n 4 SU2_GEO config_tmpl.cfg",True)
geometryFDRun.addConfig("config_tmpl.cfg")
...
thicknessConstraint1 = Function("GEOMETRY","GEOMETRY/of_func.csv",TableReader(0,0,start=(-1,18),end=(None,None),delim=","))
thicknessConstraint1.addInputVariable(var,"GEOMETRY/of_grad.csv",TableReader(None,0,start=(4,19),end=(None,None),delim=","))
...
thicknessConstraint2 = Function("GEOMETRY","GEOMETRY/of_func.csv",TableReader(0,0,start=(-1,19),end=(None,None),delim=","))
thicknessConstraint2.addInputVariable(var,"GEOMETRY/of_grad.csv",TableReader(None,0,start=(4,20),end=(None,None),delim=","))
...
thicknessConstraint3 = Function("GEOMETRY","GEOMETRY/of_func.csv",TableReader(0,0,start=(-1,20),end=(None,None),delim=","))
thicknessConstraint3.addInputVariable(var,"GEOMETRY/of_grad.csv",TableReader(None,0,start=(4,21),end=(None,None),delim=","))
...
thicknessConstraint4 = Function("GEOMETRY","GEOMETRY/of_func.csv",TableReader(0,0,start=(-1,21),end=(None,None),delim=","))
thicknessConstraint4.addInputVariable(var,"GEOMETRY/of_grad.csv",TableReader(None,0,start=(4,22),end=(None,None),delim=","))
...
thicknessConstraint5 = Function("GEOMETRY","GEOMETRY/of_func.csv",TableReader(0,0,start=(-1,22),end=(None,None),delim=","))
thicknessConstraint5.addInputVariable(var,"GEOMETRY/of_grad.csv",TableReader(None,0,start=(4,23),end=(None,None),delim=","))
...
driver.addEquality(liftConstraint, 0.2077, 1.0)
