...
pType_Iter_piggysteps = Parameter(["1"],LabelReplacer("__NUM_ITER__"))
...
pType_Iter_OneShot_iter = Parameter(["5"],LabelReplacer("__OSITER__"))
pType_OneShot_step = Parameter(["1e-12"], LabelReplacer("__OSSTEP__"))
### END # DEFINE CONFIG, MESH, CONFIG LABELS #

### ALL IN ONE RUN ###
optimizerRun = ExternalSU2CFDOneShotSingleZoneDriverWithRestartOption("ONESHOT","mpirun -n 4 SU2_CFD_AD config_Optimization_tmpl.cfg",True,"config_Optimization_tmpl.cfg")
optimizerRun.addConfig("config_Optimization_tmpl.cfg")
optimizerRun.addData("mesh_tutorial_ffd.su2")
...
fun = Function("DRAG","ONESHOT/history.dat",TableReader(0,0,start=(-1,17),end=(None,None),delim=","))
